    ...
    return (
        ...
        <div ref={reactFlowWrapper} style={{width: '100vw', height: '80vh'}}>
            ...
            >
                ...
                <MiniMap style={{ backgroundColor: '#140C2A', border: '1px solid #3B1D6B', borderRadius: '4px', height: 100, width: 200 }} maskColor="rgba(42, 20, 80, 0.6)" nodeColor="#6C3FC9" nodeStrokeColor="#4C2490" nodeBorderRadius={2} />
            </ReactFlow>
        </div>
        </>
    )
